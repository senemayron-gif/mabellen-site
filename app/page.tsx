...
export default function MabellenApp() {
  ...
  // --- FUNÇÕES DE ARQUIVO E CROP (ELEGÂNCIA E SIMPLICIDADE) ---
  ...
  const aoSelecionarArquivos = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files && e.target.files.length > 0) {
      ...
      // Nota: Para múltiplas imagens, este fluxo pode ser repetido ou simplificado.
      // Aqui, tratamos uma por uma para garantir o enquadramento perfeito.
    }
  }
  ...
  return (
    <div className="min-h-screen bg-white pb-24 font-sans text-black">
      ...
      {/* MODAL ADMINISTRATIVO (CADASTRO MAIS ELEGANTE) */}
      {isAdmin && (
        <div className="fixed inset-0 bg-gray-50 z-[300] p-6 md:p-10 overflow-y-auto animate-in slide-in-from-bottom duration-500 text-black">
          <div className="max-w-3xl mx-auto bg-white p-8 rounded-[3rem] shadow-xl border border-gray-100">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div className="space-y-6">
                    <label className="block text-[11px] font-bold text-gray-400 tracking-widest uppercase mb-3">Fotos do Produto (Enquadramento Perfeito)</label>
      ...
      {/* MODAL DE RECORTAR IMAGEM (CROP) - ELEGÂNCIA E ENQUADRAMENTO */}
      {imagemParaCrop && (
        <div className="fixed inset-0 bg-black/80 z-[400] p-6 md:p-20 flex items-center justify-center animate-in fade-in duration-300">
            <div className="bg-white p-8 rounded-[3rem] shadow-2xl max-w-xl w-full">
                
                <div className="flex justify-between items-center mb-8 border-b pb-5 text-black">
                    <div className='flex items-center gap-3'>
      ...
      {/* CARRINHO / SACOLA - CONTINUA IGUAL */}
      {showCarrinho && (
